  ...
  return (
    <div className="flex flex-row h-screen w-screen">
      <div className="flex flex-col items-center justify-center gap-8 basis-3/5 bg-white [-webkit-app-region:_drag]">
        <button className="absolute top-3 start-3 bg-[#bcbcbc] active:bg-[#acabab] hover:bg-[#929292] rounded-full w-4 h-4 flex items-center justify-center">
        ...
        <div className="flex flex-col w-full max-w-80 gap-2.5">
          <button className="bg-[#eeeded] active:bg-[#e7e6e6] rounded-lg p-2 flex flex-row items-center gap-2 flex-1 font-medium text-sm">
